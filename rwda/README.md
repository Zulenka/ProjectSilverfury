...
## HelpDB / Export Import

RWDA can now load the exported Achaea help dataset Lua tables generated by `achaea_lua_exporter.py`.

Recommended location:

- `rwda/vendor/silverfury_data/` inside the RWDA package folder, or
- `achaea_help_dataset/processed/lua/silverfury_data/` next to the package.

In Mudlet:

- `rwda helpdb status`
- `rwda helpdb import C:\\path\\to\\silverfury_data`
- `rwda helpdb search doubleslash`
- `rwda helpdb ability doubleslash`

At bootstrap RWDA will attempt to auto-load the export from common locations.
