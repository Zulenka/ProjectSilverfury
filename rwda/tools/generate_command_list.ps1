...
$descriptions = @{
  ...
  "retaliate <on|off>" = "Toggle auto-retaliation target lock on aggressor hits."
  "execute <on|off>" = "Toggle auto execute/finisher lifecycle automation."
  ...
  "set retalockms <ms>" = "Set retaliation lock duration in milliseconds."
  "set retaldebounce <ms>" = "Set minimum milliseconds between retaliation target swaps."
  "set retalminconf <0-1>" = "Set minimum aggressor detection confidence for auto-retaliation."
  "set executecooldown <ms>" = "Set execute attempt cooldown in milliseconds."
  "set executefallbackwindow <ms>" = "Set fallback forcing window after failed execute."
  "set executetimeout <disembowel|devour> <ms>" = "Set execute timeout per finisher action."
  "set executefallback <human|dragon> <block_id>" = "Set fallback strategy block ID for human/dragon execute failure."
